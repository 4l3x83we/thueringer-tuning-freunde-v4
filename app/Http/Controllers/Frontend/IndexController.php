...
class IndexController extends Controller
{
    public function index()
    {
        ...
        $veranstaltungens = Veranstaltungen::where('datum_bis', '>=', now())->where('datum_von', '>=', now())->select('id', 'anwesend', 'datum_von', 'datum_bis', 'veranstaltung', 'veranstalter', 'eintritt', 'slug', 'veranstaltungsort', 'quelle')->orderBy('datum_von', 'ASC')->limit(6)->get();
        $preview = null;
