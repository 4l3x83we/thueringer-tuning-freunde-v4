 ...
 *
 * File: TeilnahmeMailAdminMail.php
 * User: ${USER}
...
class TeilnahmeMailAdminMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        if ($this->assumed->present === 1) {
            $present = "(Admin Mail) Teilnahmebestätigung für die Versammlung am: {$this->von}";
        } else {
            $present = "(Admin Mail) Absage für die Versammlung am: {$this->von}";
        }
    ...
    {
        return new Content(view: 'emails.calendar.teilnahme-mail-admin',);
    }
