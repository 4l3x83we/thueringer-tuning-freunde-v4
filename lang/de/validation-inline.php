...
return [
    ...
    "between.numeric" => "Dieser Wert muss zwischen :min & :max liegen.",
    "between.string" => "Diese Zeichenkette muss zwischen :min & :max Zeichen lang sein.",
    ...
    "gt.array" => "Der Inhalt muss mehr als :value Elemente haben.",
    "gt.file" => "Die Datei muss größer als :value Kilobytes sein.",
    "gt.numeric" => "Der Wert muss größer als :value sein.",
    "gt.string" => "Die Zeichenkette muss länger als :value Zeichen sein.",
    "gte.array" => "Der Inhalt muss mindestens :value Elemente haben.",
    "gte.file" => "Die Datei muss größer oder gleich :value Kilobytes sein.",
    "gte.numeric" => "Der Wert muss größer oder gleich :value sein.",
    "gte.string" => "Die Zeichenkette muss mindestens :value Zeichen lang sein.",
    ...
    "lt.array" => "Der Inhalt muss weniger als :value Elemente haben.",
    "lt.file" => "Die Datei muss kleiner als :value Kilobytes sein.",
    "lt.numeric" => "Der Wert muss kleiner als :value sein.",
    "lt.string" => "Die Zeichenkette muss kürzer als :value Zeichen sein.",
    "lte.array" => "Der Inhalt darf maximal :value Elemente haben.",
    "lte.file" => "Die Datei muss kleiner oder gleich :value Kilobytes sein.",
    "lte.numeric" => "Der Wert muss kleiner oder gleich :value sein.",
    "lte.string" => "Die Zeichenkette darf maximal :value Zeichen lang sein.",
    "mac_address" => "Der Wert muss eine gültige MAC-Adresse sein.",
    "max.array" => "Der Inhalt darf maximal :max Elemente haben.",
    "max.file" => "Die Datei darf maximal :max Kilobytes groß sein.",
    "max.numeric" => "Der Wert darf maximal :max sein.",
    "max.string" => "Die Zeichenkette darf maximal :max Zeichen haben.",
    ...
    "min.array" => "Der Inhalt muss mindestens :min Elemente haben.",
    "min.file" => "Die Datei muss mindestens :min Kilobytes groß sein.",
    "min.numeric" => "Der Wert muss mindestens :min sein.",
    "min.string" => "Die Zeichenkette muss mindestens :min Zeichen lang sein.",
    ...
    "password.letters" => "Dieses Feld muss mindestens einen Buchstaben beinhalten.",
    "password.mixed" => "Dieses Feld muss mindestens einen Großbuchstaben und einen Kleinbuchstaben beinhalten.",
    "password.numbers" => "Dieses Feld muss mindestens eine Zahl beinhalten.",
    "password.symbols" => "Dieses Feld muss mindestens ein Sonderzeichen beinhalten.",
    "password.uncompromised" => "Dieses Feld wurde in einem Datenleck gefunden. Bitte ändern Sie Ihre Eingabe.",
    ...
    "size.array" => "Der Inhalt muss genau :size Elemente haben.",
    "size.file" => "Die Datei muss :size Kilobyte groß sein.",
    "size.numeric" => "Der Wert muss gleich :size sein.",
    "size.string" => "Die Zeichenkette muss :size Zeichen lang sein.",
