...
@section('title') Bearbeite Mitglied: {{ $team->title }}@endsection
    ...
    <section class="team" id="team">
        <div class="container" data-aos="fade-up">
            ...
            <form action="{{ route('frontend.team.update', $team->slug) }}" method="POST" enctype="multipart/form-data" class="row" id="teamEdit">
                ...
                <div class="col-lg-12 shadow mt-4 text-bg-dark teamEdit" data-aos="fade-up" data-aos-delay="100">
                    <div class="header">
                        <h5>Kontaktdaten</h5>
                    </div>
                    <div class="body">
                ...
                <div class="col-lg-12 text-bg-dark shadow mt-4 teamEdit">
                    <div class="d-flex justify-content-end px-4 py-3">
                        <button type="submit" class="btn btn-sm btn-primary fw-bold position-relative shadow">Änderungen speichern</button>
                    </div>
                </div>
            </form>
