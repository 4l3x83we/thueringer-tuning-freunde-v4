...
<script type="text/javascript">
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('/service-worker.js', {
            ...
            console.log('Laravel PWA: ServiceWorker-Registrierung mit Scope erfolgreich: ', registration.scope);
        }, function (err) {
            // registration failed :(
            console.log('Laravel PWA: ServiceWorker-Registrierung fehlgeschlagen: ', err);
        });
    }
</script>
